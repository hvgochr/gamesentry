...
class UpdateTrackedPlayerRequest extends FormRequest
{
    ...
    {
        /** @var TrackedPlayer|null $trackedPlayer */
        $trackedPlayer = $this->route('trackedPlayer');
        ...
        return [
            ...
            'riot_name' => [
                ...
                'string',
                'max:32',
                Rule::unique('tracked_players', 'riot_name')
                    ->where(
                        fn ($query) => $query
